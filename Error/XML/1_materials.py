...
def mix_FNSFIBSR(material_library):
    ...
    FNSFIBSR_mat.metadata["mat_number"] = 1002
...
def main():
    ...
    simulationLib["FW"] = FW
    simulationLib["HeManifolds"] = HeManifolds
    simulationLib["Manifolds"] = Manifolds
    simulationLib["VVFill"] = VVFill
    simulationLib["LTS"] = LTS
    simulationLib["coils"] = coils
    simulationLib["HCPB"] = HCPB
    simulationLib["BW"] = BW

    # from library
    simulationLib["SS316L"] = SS316L  # VV front and back plate
    simulationLib["He"] = He
    simulationLib["EUROFER97"] = EUROFER97
