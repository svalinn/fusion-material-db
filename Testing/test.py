...
def test_mat() :
    nucvec = {60000000: 0.11, 230000000: 0.19, 240000000: 8.9, 250000000: 0.42, 260000000: 89.14, 730000000: 0.14, 740000000: 1.10}
    test = Material(nucvec)
    test.density = 7.75
    test=test.expand_elements()
    test.metadata['citation']='MergiaJNM_2008'
    print(test)
    return test
...
def HeT410P1_mat() :
    HeT410P1 = Material()
    HeT410P1.from_atom_frac({20000000: 1})
    HeT410P1.density = 0.007048 # at 410 C, 1 bar
...
# fullreference: HernandezFusEngDes_2018 F.A. Hernandez, P. Pereslavtsev, Fusion Engineering and Design vol. 137, 2018 https://doi.org/10.1016/j.fusengdes.2018.09.014
def Zr_mat() :
    nucvec = {400000000:1.0}
    Zr = Material(nucvec)
    Zr.density = 3.56
    Zr=Zr.expand_elements()
    Zr.metadata['citation']='HernandezFusEngDes_2018'
    return Zr
...
def Inconel788_mat() :
    nucvec =    { 50000000: 0.0050,
                 ...
                 410000000: 5.1250,
                 420000000: 3.0500}
    Inconel788 = Material(nucvec)
    Inconel788.density = 9.19 # room temperature
    Inconel788=Inconel788.expand_elements()
    Inconel788.metadata['citation']='pnnl-15870rev1'
    return Inconel788
...
#
    ...
    mat_lib['Inconel788']= Inconel788_mat()   
    # remove lib
    try: 
    ...
    mat_lib.write_openmc("test_results.xml")
    print("All done!")
