...
mat_data["Li2TiO3mass"] = {
    "nucvec": {30000000: 2, 80000000: 3, 220000000: 1},
    "density": 3.43,
    "citation": "HernandezFusEngDes_2018",
}

mat_data["Li2TiO3mass60"] = {
    "nucvec": {30060000: (.6*2), 30070000: (2*.4), 80000000: 3, 220000000: 1},
    "density": 3.43,
    "citation": "HernandezFusEngDes_2018",
}

mat_data['Li4SiO4mass'] = {
    'nucvec' : {30000000:4, 80000000:4, 140000000:1},
    'density' : 2.40,
    "citation" : 'HernandezFusEngDes_2018'
    }

mat_data["Li4SiO4mass60"] = {
    "nucvec": {30060000: (.6*4), 30070000: (4*.4), 80000000: 4, 140000000: 1},
    "density": 3.43,
    "citation": "HernandezFusEngDes_2018",
}
...
mat_data['Li4SiO4_atom_oxygen'] = {
    'atom_frac' : {liXweightfraction:4, OXweightfraction:4, 140000000:1},
    'density' : 2.40,
    'citation' : 'HernandezFusEngDes_2018'
    }
# example of nucvec not working the same as atom
"""
mat_data['Li4SiO4_mass_oxygen'] = {
    'nucvec' : {liXweightfraction:4, OXweightfraction:4, 140000000:1},
    'density' : 2.40,
    'citation' : 'HernandezFusEngDes_2018'
    }
"""

mat_data['Li2TiO3_mass_oxygen'] = {
    'nucvec' : {30060000: (.6*2), 30070000: (2*.4),80160000: (0.6*3), 80170000: (0.2*3), 80180000: (0.2*3), 220000000: 1},
    'density' : 3.43,
    'citation' : 'HernandezFusEngDes_2018'
    }

mat_data['Li4SiO4_mass_oxygen'] = {
    'nucvec' : {30060000: (.6*4), 30070000: (4*.4),80160000: 0.6*4, 80170000: 0.2*4, 80180000: 0.2*4, 140000000: 1},
    'density' : 2.40,
    'citation' : 'HernandezFusEngDes_2018'
    }
...
def main():
    ...
    # remove lib
    try: 
        os.remove("testing_PureFusionMaterials_libv1.json")
    except: 
        pass  
        
    # write fnsf1d material library
    mat_lib.write_json("testing_PureFusionMaterials_libv1.json")
